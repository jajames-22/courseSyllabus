...
if (isset($_POST['verify'])) {
    if(!$accountsObj->isEmployeeIdExist($account['employee_id'])){
        if ($accountsObj->verifyAccount($id)) { 
            ...
            header("Location: admin.php?page=manageAcc");
            exit;
        }
    } else {
...
<body>
    <section class="side-bar">
        ...
        <div>
            <ul>
                <li class="option <?php if ($_SESSION["page"] == 'dashboard') echo 'active'; ?>" onclick="location.href='admin.php?page=dashboard'">
                <img class="tab-icon" src="../styles/images/dashboard_icon_red.svg" alt="">Dashboard</li>

                <li class="option <?php if ($_SESSION["page"]== 'manageSyllabus') echo 'active'; ?>" onclick="location.href='admin.php?page=manageSyllabus'">
                <img class="tab-icon" src="../styles/images/book_icon_red.svg" alt="">Manage Syllabus</li>

                <li class="option <?php if ($_SESSION["page"]== 'manageAcc') echo 'active'; ?>" onclick="location.href='admin.php?page=manageAcc'">
                <img class="tab-icon" src="../styles/images/group_icon.svg" alt="">Manage Accounts</li>

                <li class="option <?php if ($page == 'notifications') echo 'active'; ?>" onclick="location.href='admin.php?page=notifications'">
                <img class="tab-icon" src="../styles/images/notifications_icon_red.svg" alt="">Notifications</li>

                <li class="option <?php if ($_SESSION["page"]== 'myAccount') echo 'active'; ?>" onclick="location.href='admin.php?page=myAccount'">
                <img class="tab-icon" src="../styles/images/account_icon_red.svg" alt="">My Accounts</li>
            </ul>
        </div>
    </section>
    <section class="content">
        ...
        <div class="selected">
            <button class="back-btn" onclick="window.location.href='admin.php?page=<?php echo $_SESSION['page']; ?>'"><- Go Back</button>
