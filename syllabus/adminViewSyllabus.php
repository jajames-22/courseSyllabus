...
if (isset($_GET["id"])) {
    ...
    if (!$syllabus) {
        echo "<a href='admin.php?page=dashboard'>Back to Dashboard</a>";
...
<head>
    ...
    <title>Admin | View Syllabus</title>
</head>
<body>
    <section class="side-bar">
        ...
        <div>
            <ul>
                ...
                <li class="option active" onclick="location.href='admin.php?page=manageSyllabus'">
                ...
                <img class="tab-icon" src="../styles/images/group_icon_red.svg" alt="">Manage Accounts</li>
